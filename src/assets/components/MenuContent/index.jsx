    ...
    >
      <div>
        <motion.span
          ...
          className="relative z-10 block text-4xl font-bold  text-neutral-50 transition-colors duration-500 group-hover:text-neutral-400 md:text-6xl"
        >
        ...
        <span className="relative z-10 mt-2 block text-base text-neutral-100 transition-colors duration-500 group-hover:text-neutral-400">
          {subheading}
        </span>
      </div>
