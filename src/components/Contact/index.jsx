...
export default function Contact() {
  ...
  return (
    <div className="mt-12 md:mt-20 mx-auto px-4 md:px-5">
        ...
        <div className="glass-effect rounded-2xl p-6 md:p-8">
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="flex items-center gap-3 md:gap-4">
              <div className="relative icon-container bg-gray-700 rounded-lg flex items-center justify-center transition-colors duration-200 hover:bg-gray-600">
          ...
          <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-white/20">
            ...
            <div className="flex gap-3 md:gap-4">
              <a
                ...
                className="relative icon-container bg-gray-700 rounded-lg flex items-center justify-center transition-colors duration-200 hover:bg-gray-600"
              >
        ...
        >
          ...
          >
            ...
            <button
              ...
              className={`relative w-full bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold py-2 md:py-3 px-4 md:px-6 rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base ${
