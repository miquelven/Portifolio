  ...
  return (
    <div className="flex justify-center w-2/3 m-auto shadow-md transition-all duration-300 border-2 border-[#fcfcfc] left-4 right-4 z-10 rounded-lg  bg-white  text-[#fcfcfc] backdrop-blur font-bold  hover:shadow-[#090909] hover:-translate-x-[1px] hover:-translate-y-[5px] max-sm:border-[#245276] max-sm:text-[#245276] max-sm:hover:shadow-black">
      <a
        ...
        className="transform active:scale-95 bg-[#3c88c4] text-[#fcfcfc] px-16 py-2 rounded-lg font-bold tracking-widest w-full max-sm:bg-[#d9e8f3] max-sm:text-[#245276] "
      >
        <div className="flex justify-center items-center relative">
          <div className="svg-container">
            ...
            >
              <path
                className="download-arrow stroke-[#fcfcfc] max-sm:stroke-[#245276]"
              ...
              />
              <path
                className="stroke-[#fcfcfc] max-sm:stroke-[#245276]"
            ...
            <div
              ...
              ref={downloadLoader}
              id="download-loader"
              className="text-[#fcfcfc] hidden max-sm:text-[#245276]"
            ></div>
            <svg
            ...
            >
              <path
                className="fill-[#fcfcfc] max-sm:fill-[#245276]"
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <div
            ref={downloadText}
            className="pl-2 text-sm text-[#fcfcfc] leading-none uppercase font-semibold max-lg:text-xs max-sm:text-[#245276]  "
          >
            Currículo
          </div>
        </div>
